<x-app-layout>
    <h4 class="breadcrumb-wrapper">
        ...
        <div class="breadcrumb-title">Usuários</div>
    </h4>
    <div class="content">
        ...
        <form name="formSearch" id="formSearch" method="post" action="{{ route('exercicios.search') }}">
            @csrf
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xs-3 col-sm-2 col-md-2 col-lg-2 form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Ex: João   " name="filter_usuario">
                        </div>

                        <div class="col-xs-3 col-sm-2 col-md-2 col-lg-2 form-group">
                            <label class="form-label">Treino</label>
                            <select name="filter_treino" id="filter_treino" class="form-control" style="width: 100%">
                                <option value="">-</option>
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="button">
                    ...
                    <button type="button" class="btn btn-sm btn-secondary"
                        onclick="Tela.abrirJanela('{{ route('exercicios.create') }}', 'Novo Exercicio', 'lg')">
