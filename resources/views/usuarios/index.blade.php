<x-app-layout>
    ...
    <div class="content">
        ...
        <form name="formSearch" id="formSearch" method="post" action="{{ route('usuarios.search') }}">
            @csrf
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xs-3 col-sm-2 col-md-2 col-lg-2 form-group">
                            ...
                            <select name="filter_grupo" id="filter_grupo" class="form-control" style="width: 100%">
                                <option value="">-</option>
