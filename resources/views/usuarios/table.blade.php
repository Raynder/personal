                    ...
                    <td width="150" class="text-center">
                        <div class='btn-group'>
                            <a href="javascript:void(0);"
                                onclick="Tela.abrirJanela('{{ route('usuarios.edit', [$obj->id]) }}', 'Editar  Usuário', 'lg')"
                                class="btn-table btn-xs">
                                <i class="fa fa-pencil-alt"></i>
                            </a>
                            <a href="javascript:void(0);"
                                onclick="Tela.abrirJanela('{{ route('usuarios.show', [$obj->id]) }}', 'Visualizar Acesso do Usuário', 'lg')"
                                class="btn-table btn-xs">
                                <i class="fa fa-eye"></i>
                            </a>
                            <a href="javascript:void(0);" class="btn-table btn-table-danger btn-xs"
                                onclick="Tela.abrirJanelaExcluir('{{ route('usuarios.destroy', [$obj->id]) }}?_token={{ csrf_token() }}', '{{ $obj->id }}')">
