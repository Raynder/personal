                    ...
                    <td width="150">
                        <div class='btn-group'>
                            <a href="javascript:void(0);"
                                onclick="Tela.abrirJanela('{{ route('novidades.edit', [$obj->id]) }}', 'Editar Novidade', 'lg')"
                        ...
                        <div class='btn-group'>
                            <a href="javascript:void(0);"
                                onclick="Tela.abrirJanelaExcluir('{{ route('novidades.destroy', [$obj->id]) }}?_token={{ csrf_token() }}', '{{ $obj->id }}')"
