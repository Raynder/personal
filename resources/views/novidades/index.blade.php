<x-app-layout>
    ...
    <div class="content">
        ...
        <form name="formSearch" id="formSearch" method="post" action="{{ route('novidades.search') }}">
            @csrf
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xs-4 col-sm-3 col-md-3 col-lg-3 form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Nome ou parte do nome da novidade"
                                name="filter_nome">
                        </div>
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="button">
                    ...
                    <button type="button" class="btn btn-sm btn-secondary"
                        onclick="Tela.abrirJanela('{{ route('novidades.create') }}', 'Nova Atualização', 'lg')">
